...
import { ArrowLeft, SkipBack, SkipForward, Keyboard } from "lucide-react";

export default function PlayerPage() {
  const params = useParams();
  const router = useRouter();
  const { videos, currentVideo, updateProgress, setCurrentVideo, isLoading } =
    useVideoLibrary();
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-center">
            <button
              ...
              className="flex items-center gap-2 px-3 py-1 bg-card/50 hover:bg-card/70 text-foreground/60 rounded-lg transition-colors text-sm"
            >
